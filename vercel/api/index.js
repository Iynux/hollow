...
<h1>zero</h1>
<p>API online.</p>
<code style="display:block;padding:12px;background:#1a1a24;border-radius:8px;white-space:pre-wrap">loadstring(game:HttpGet("https://fuckmark.vercel.app/hollow-loader.lua"))()</code>
</div></body></html>`);
};
